...
export default {
  ...
  data() {
    return {
      // downBtn: [require("../assets/back.png"), require("../assets/close.png")],
      // upBtn: [require("../assets/back.png"), require("../assets/close.png")],
      // playBtn: [
      //   require("../assets/icon_audio_play@2x.png"),
      //   require("../assets/icon_audio_pause@2x.png")
      // ],
      isPlay: false,
